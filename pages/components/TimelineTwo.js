            ...
            <div className="flex flex-col grid-cols-9 pt-2 pb-6 mx-auto text-white md:grid">
                ...
                <div className="flex flex-row-reverse md:contents">
                    <div className="col-start-1 col-end-5 pl-2 my-4">
                        ...
                        <p className="leading-tight text-justify">
                            ...
                            quaerat? Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi,
                            quaerat? Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi,
                            quaerat? Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi,
                            quaerat?
                        </p>
                    ...
                    <div className="relative col-start-5 col-end-6 mr-10 md:mx-auto">
                        <div className="flex items-center justify-center w-6 h-full">
                            <div className="w-1 h-full bg-white pointer-events-none">

                            </div>
                        </div>
                        <div className="absolute w-6 h-6 -mt-4 bg-white rounded-full shadow top-1/2">
                ...
                <div className="flex md:contents">
                    <div className="relative col-start-5 col-end-6 mr-10 md:mx-auto">
                        ...
                        <div className="absolute w-6 h-6 -mt-3 bg-white rounded-full shadow top-1/2">
                ...
                <div className="flex flex-row-reverse md:contents">
                    ...
                    <div className="relative col-start-5 col-end-6 mr-10 md:mx-auto">
                        ...
                        <div
                            className="absolute w-6 h-6 -mt-3 bg-white rounded-full shadow top-1/2"
                        ></div>
                    </div>
                </div>
                {/*right*/}
