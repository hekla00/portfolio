...
export default function Footer() {
  ...
  return (
    <div className="px-4 pt-16 mx-auto w-full md:px-2 lg:px-0">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-2">
        <div className="space-y-2 text-sm">
          <p className="pl-6 text-base font-bold tracking-wide text-gray-900">
            <a onClick={() => scrollToTop()}>Back to top</a>
          </p>
        </div>
        <div>
          <div className="flex items-right mt-1 space-x-3">
            <a
      ...
      <div className="pl-6 flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-600">
          Copyright © Hekla Alexia Samuelsdottir 2021. All rights reserved.
        </p>
      </div>
    </div>
  );
